...
const navItems = [
  ...
  { href: "/dashboard/profile", label: "プロフィール", Icon: ProfileIcon },
  { href: "/dashboard/companies", label: "企業管理", Icon: CompanyIcon },
  { href: "/dashboard/history", label: "提出履歴", Icon: HistoryIcon },
